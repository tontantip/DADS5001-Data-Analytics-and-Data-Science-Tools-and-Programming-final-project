...
# ใส่ชื่อโมเดลให้ตรงกับที่มีในเครื่อง (เช็คด้วยคำสั่ง 'ollama list' ใน terminal)
# แนะนำ: 'qwen2.5:7b' (ถ้าคุณหมายถึง Qwen รุ่นล่าสุด) หรือ 'llama3.1:8b'
#MODEL_NAME = 'llama3.2:3b' 
MODEL_NAME = 'gemma3:1b' 

# สมมติว่า df คือ DataFrame หุ้นของคุณ
df = index_stock.copy()
# --- ฟังก์ชันช่วยเหลือ ---
...
def create_prompt(row):
    # Qwen เข้าใจ Prompt ภาษาอังกฤษได้ดีและแม่นยำกว่าภาษาไทยเล็กน้อยในงาน JSON
    # แต่ยังสามารถรับ Input ภาษาไทยได้ ผมจะผสมเพื่อให้โมเดลทำงานได้ดีที่สุดครับ
