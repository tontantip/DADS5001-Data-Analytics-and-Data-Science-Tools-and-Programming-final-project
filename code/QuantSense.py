...
st.image("https://github.com/tontantip/Archive/blob/main/Image_dads5001_project/Gemini_Generated_Image_fbw36jfbw36jfbw3.png?raw=true",caption="Methodology of AI section",use_column_width=True)

st.markdown("### 💻Machine Learning")
st.image("https://github.com/tontantip/Archive/blob/main/Image_dads5001_project/ML_Methodology%20(2816%20x%201536%20px).png?raw=true",caption="Methodology of Machine learning section",use_column_width=True)
